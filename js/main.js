...
var _user$project$Post$lookupPost = F2(
	function (id, posts) {
...
var _user$project$Post$Post = F3(
	function (a, b, c) {
		return {id: a, title: b, body: c};
	});
var _user$project$Post$posts = function () {
	var post = A4(
		_elm_lang$core$Json_Decode$map3,
		_user$project$Post$Post,
		A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'body', _elm_lang$core$Json_Decode$string));
	return _elm_lang$core$Json_Decode$list(post);
}();
var _user$project$Post$fetchPosts = _elm_lang$http$Http$toTask(
	A2(_elm_lang$http$Http$get, '/api/posts.json', _user$project$Post$posts));
...
var _user$project$Routes$PostR = function (a) {
	return {ctor: 'PostR', _0: a};
};
var _user$project$Routes$postR = A2(
	_Bogdanp$elm_route$Route_ops[':='],
	_user$project$Routes$PostR,
	A2(
		_Bogdanp$elm_route$Route_ops['</>'],
		_Bogdanp$elm_route$Route$static('posts'),
		_Bogdanp$elm_route$Route$int));
var _user$project$Routes$PostsR = {ctor: 'PostsR'};
var _user$project$Routes$postsR = A2(
	_Bogdanp$elm_route$Route_ops[':='],
	_user$project$Routes$PostsR,
	_Bogdanp$elm_route$Route$static('posts'));
...
var _user$project$Routes$sitemap = _Bogdanp$elm_route$Route$router(
	{
		...
		_1: {
			ctor: '::',
			_0: _user$project$Routes$postsR,
			_1: {
				ctor: '::',
				_0: _user$project$Routes$postR,
				_1: {
					ctor: '::',
...
var _user$project$Main$post = function (post) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('mb-2'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Main$loading = _rundis$elm_bootstrap$Bootstrap_Alert$warning(
	{
		ctor: '::',
...
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {route: a, navbarState: b, ready: c, posts: d, post: e, error: f};
	});
...
var _user$project$Main$handleRoute = F2(
	function (route, _p0) {
		var _p1 = _p0;
		var _p3 = _p1.ready;
		var fetchPosts = A2(_elm_lang$core$Task$attempt, _user$project$Main$Fetch, _user$project$Post$fetchPosts);
			...
			case 'PostR':
				return _p3 ? A2(
					...
					_elm_lang$core$Native_Utils.update(
						newModel,
						{
							post: A2(_user$project$Post$lookupPost, _p2._0, newModel.posts)
						}),
					{ctor: '[]'}) : A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					newModel,
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			case 'RouteChanged':
				return A2(_user$project$Main$handleRoute, _p4._0, model);
			case 'RouteTo':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						ctor: '::',
						_0: _user$project$Routes$navigateTo(_p4._0),
						_1: {ctor: '[]'}
					});
			case 'NavbarMsg':
				return A2(
			...
			default:
				if (_p4._0.ctor === 'Err') {
					...
					return A2(
						_user$project$Main$handleRoute,
						model.route,
						_elm_lang$core$Native_Utils.update(
							model,
							{ready: true, error: _elm_lang$core$Maybe$Nothing, posts: _p4._0._0}));
				}
		}
	});
...
var _user$project$Main$init = function (location) {
	var _p5 = _rundis$elm_bootstrap$Bootstrap_Navbar$initialState(_user$project$Main$NavbarMsg);
	...
	var _p6 = A2(_user$project$Main$handleRoute, initialModel.route, initialModel);
	var model = _p6._0;
	var routeCmd = _p6._1;
	return {
		ctor: '_Tuple2',
...
var _user$project$Main$RouteTo = function (a) {
	return {ctor: 'RouteTo', _0: a};
};
var _user$project$Main$linkAttrs = function (route) {
	var onClickRoute = A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
		{preventDefault: true, stopPropagation: true},
		_elm_lang$core$Json_Decode$succeed(
			_user$project$Main$RouteTo(route)));
	return {
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$href(
			...
			_rundis$elm_bootstrap$Bootstrap_Navbar$items,
			{
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_rundis$elm_bootstrap$Bootstrap_Navbar$itemLink,
							_user$project$Main$linkAttrs(_user$project$Routes$PostsR),
							{
								ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$a,
						_user$project$Main$linkAttrs(
							_user$project$Routes$PostR(123)),
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Click to fetch post #123 which doesn\'t exist'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$Main$posts = function (posts) {
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$html$Html$a,
					_user$project$Main$linkAttrs(
						_user$project$Routes$PostR(post.id)),
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(post.title),
						_1: {ctor: '[]'}
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$ul,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, postLink, posts)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$content = function (_p7) {
	var _p8 = _p7;
	var _p11 = _p8;
	var _p9 = _p11.route;
	switch (_p9.ctor) {
		...
		case 'PostsR':
			return _p11.ready ? _user$project$Main$posts(_p11.posts) : _user$project$Main$loading;
		case 'PostR':
			var _p10 = {ctor: '_Tuple2', _0: _p11.ready, _1: _p11.post};
			if (_p10._0 === false) {
				return _user$project$Main$loading;
			} else {
				if (_p10._1.ctor === 'Nothing') {
					return _user$project$Main$notFound;
				} else {
					return _user$project$Main$post(_p10._1._0);
				}
			}
		case 'AboutR':
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$navigation(model),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
...
var _user$project$Main$parseRoute = function (_p12) {
	return _user$project$Main$RouteChanged(
		_user$project$Routes$parsePath(_p12));
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Bootstrap.Navbar.Visibility":{"args":[],"tags":{"AnimatingDown":[],"StartDown":[],"StartUp":[],"AnimatingUp":[],"Hidden":[],"Shown":[]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Routes.Sitemap":{"args":[],"tags":{"HomeR":[],"NotFoundR":[],"AboutR":[],"PostR":["Int"],"PostsR":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"Fetch":["Result.Result Http.Error (List Post.Post)"],"RouteTo":["Routes.Sitemap"],"NavbarMsg":["Bootstrap.Navbar.State"],"RouteChanged":["Routes.Sitemap"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Bootstrap.Navbar.DropdownStatus":{"args":[],"tags":{"ListenClicks":[],"Closed":[],"Open":[]}},"Bootstrap.Navbar.State":{"args":[],"tags":{"State":["Bootstrap.Navbar.VisibilityState"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Bootstrap.Navbar.VisibilityState":{"args":[],"type":"{ visibility : Bootstrap.Navbar.Visibility , height : Maybe.Maybe Float , windowSize : Maybe.Maybe Window.Size , dropdowns : Dict.Dict String Bootstrap.Navbar.DropdownStatus }"},"Post.Post":{"args":[],"type":"{ id : Int, title : String, body : String }"},"Window.Size":{"args":[],"type":"{ width : Int, height : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
